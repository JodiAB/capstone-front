...
.body {
  ...
  background-image: url(https://virtualbackgrounds.site/wp-content/uploads/2020/09/sauna.jpg);
...
.but {
  top: calc(100% - 70px); /* Adjust as needed */
  padding: 10px;
  background: none;
  color: #ccc434;
  text-transform: uppercase;
  text-decoration: none;
  border: 0.2em solid #ccc434;
