    ...
    <div class="container" :class="{ 'right-panel-active': isSignUp }">
      ...
      <div class="form-container sign-in-container">
        <form @submit.prevent="handleSignIn">
          ...
          <input v-model="signInData.email" type="email" placeholder="Email" />
          <input v-model="signInData.password" type="password" placeholder="Password" />
      ...
      <div class="overlay-container">
        <div class="overlay">
          <div class="overlay-panel overlay-left">
            ...
            <button class="ghost" @click="togglePanel('signIn')">Sign In</button>
          </div>
          <div class="overlay-panel overlay-right">
            <h1>Hello, Friend!</h1>
            <p>Enter your personal details and start journey with us</p>
            <button class="ghost" @click="togglePanel('signUp')">Sign Up</button>
          </div>
        </div>
      </div>
    </div>
